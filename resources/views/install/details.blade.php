          ...
          <div class="box box-primary active">
            ...
            <div class="box-body">
              ...
              <form class="form" id="details_form" method="post" 
                ...
                <h4> License Details <small class="text-danger"><?php echo str_rot13('<n uers="uggcf://AhyyWhatyr.pbz">Ahyyrq Ol AhyyWhatyr.pbz</n>');?> </h4>
                <hr/>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="email" name="ENVATO_EMAIL" class="form-control" id="envato_email" value="email@gmail.com" placeholder="optional">
