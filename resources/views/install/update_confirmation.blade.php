              ...
              <form class="form" id="details_form" method="post" 
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="ENVATO_PURCHASE_CODE" required class="form-control" value="NulJungle" id="envato_purchase_code">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="ENVATO_USERNAME" required class="form-control" value="NulJungle" id="envato_username">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="email" name="ENVATO_EMAIL" class="form-control" id="envato_email" value="email@nulljungle.com" placeholder="optional">
